        ...
        <div className="relative z-10 flex flex-wrap items-start justify-between gap-6">
          <div>
            ...
            <h1 className="section-title mt-4 text-3xl font-semibold text-ink md:text-5xl">
              Open Social Metric Dashboard
            </h1>
            <p className="mt-4 max-w-2xl text-base text-slate">
              Offline-first insights from X and LinkedIn. Drop CSV exports into
              <span className="font-semibold text-ink"> Data/raw</span> to power the
              charts, growth tracking, and top-post analysis.
            </p>
        ...
        <section className="mt-6">
          <div className="card border border-amber-200/80 bg-amber-50/70 p-4">
            ...
            <p className="mt-1 text-xs text-amber-800">
              ...
              dashboard will auto-refresh without crashing if a file is missing.
            </p>
          </div>
        </section>
      )}
